...
const (
	...
	SettingKeyDefaultGroupLoadBalance          SettingKey = "default_group_load_balance"           // 默认负载均衡策略
	SettingKeyDefaultGroupSortStrategy         SettingKey = "default_group_sort_strategy"          // 默认分组排序策略
	SettingKeyDefaultMultiplierCap             SettingKey = "default_multiplier_cap"               // 默认倍率上限（0=不限制）
...
func DefaultSettings() []Setting {
	return []Setting{
		...
		{Key: SettingKeyDefaultGroupLoadBalance, Value: ""},                                      // 为空时不覆盖分组自身设置
